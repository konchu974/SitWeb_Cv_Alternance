...
import "../Css/Responssive/ResProjects.css";
      ...
      <div className="projcard-container">
        {projects.map((project, index) => (
          <div
            ...
            style={
              project.customColor
                ? { "--projcard-color": project.customColor }
                : {}
            }
          >
            <div className="projcard-innerbox">
              <img
                ...
                src={`https://back-dugain.onrender.com/images/${project.image}`}
                alt={project.title}
              />
              <div className="projcard-textbox">
                ...
                <div className="projcard-tagbox">
                  {project.technologies.map((tech, i) => (
                    <span key={i} className="projcard-tag">
                      {tech}
                    </span>
                  ))}
                </div>
      ...
      {expandedProject && (
        <div className="see-more-overlay">
          <div className="see-more-modal">
            <button className="modal-close" onClick={closeSeeMore}>
              X
            </button>
              ...
              >
                {expandedProject.images.map((imgUrl, index) => (
                  <SwiperSlide key={index}>
                    <img
                      src={`https://back-dugain.onrender.com/images/${imgUrl}`}
