...
const Apropos = () => {
  return (
    <div className="About">
      <h1 className="titleApropos">A propos de moi</h1>
      <div className="containerAbout">
        <div className="imgAbout">
          <img
            src={aboutImage}
            alt="A representation of the subject"
        ...
        <div className="textAbout">
          <div className="logoAbout">
            <li>
              ...
              <h2 className="titleSoft">Travail d'équipe</h2>
            </li>
            <li>
              ...
              <h2 className="titleSoft">Créativité</h2>
            </li>
            <li>
              ...
              <h2 className="titleSoft">Autonomie</h2>
            </li>
          </div>
          <p>
            Passionné par le développement informatique, j’apprécie
            particulièrement le travail en équipe et la création de projets
            innovants. Curieux et créatif, j’aborde chaque défi technique comme
            une opportunité d’apprendre et de proposer des solutions originales
            et efficaces.
          </p>

          <div className="passion">
            <Link to="/gallery">
              <button className="btnres-pass">Mes Passions</button>
            </Link>
          </div>
        </div>
      </div>
